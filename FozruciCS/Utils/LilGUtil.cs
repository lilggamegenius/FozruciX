...
namespace FozruciCS.Utils {
    public static class LilGUtil {
        ...
        public static string[] splitMessage(string stringToSplit, int amountToSplit, bool removeQuotes){
        ...
        public static bool containsAny(string check, params string[] contain){
            return contain.Any(aContain => check.contains(aContain));
        }

        public static bool equalsAny(string check, params string[] equal){
            return equal.Any(aEqual => check == aEqual);
        }

        public static bool equalsAnyIgnoreCase(string check, params string[] equal){
            return equal.Any(check.equalsIgnoreCase);
        }

        public static bool containsAnyIgnoreCase(string check, params string[] equal){
            return equal.Any(aEqual => check.toLowerCase().contains(aEqual.toLowerCase()));
        }

        public static bool startsWithAny(string check, params string[] equal){
            return equal.Any(check.startsWith);
        }

        public static bool endsWithAny(string check, params string[] equal){
        ...
        public static void pause(int time, bool echoTime){
...
//    }
        ...
        public static int hash(string str, int maxNum){
            var hash = 0;
